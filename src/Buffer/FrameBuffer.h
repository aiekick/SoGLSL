...
public:	
	GLuint getFboID() { return puFBOId; }
	ct::ivec3 getSize() { return puSize; }
	int getCountTextures1D() { return (int)puTextures1D.size(); }
	int getCountTextures2D() { return (int)puTextures2D.size(); }
	int getCountRenderBuffers() { return (int)puRenderBuffers.size(); }
	int getCountAttachements() { return (int)puAttachments.size(); }
...
public:
	...
	static void SetFormatFromString(
		const std::string& vDataTypeString, GLenum *vInternalFormat, GLenum *VFormat, GLenum *vDataType);
...
public:
	...
	std::shared_ptr<FloatBuffer> GetFloatBufferFromColorAttachment_4_Chan(const int& vAttachmentId, const bool& vReadFBO, const int& vMipMapLvl = 0, const bool& vCreateNewBuffer = false);
	std::shared_ptr<FloatBuffer> GetFloatBufferFromColorAttachment_1_Chan(const int& vAttachmentId, const bool& vReadFBO, const int& vMipMapLvl = 0, const bool& vCreateNewBuffer = false);
	...
	bool SaveToJpg(const std::string& vFilePathName, const bool& vFlipY, const int& vSubSamplesCount, const int& vQualityFrom0To100, const ct::ivec2& vNewSize, const int& vAttachmentId);
