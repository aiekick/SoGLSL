...
void VRUtils::Multiply(glm::mat4& result, const glm::mat4& a, const glm::mat4& b) {
    ...
    matrixArr[12] = aArr[0] * bArr[12] + aArr[4] * bArr[13] + aArr[8] * bArr[14] + aArr[12] * bArr[15];
    matrixArr[13] = aArr[1] * bArr[12] + aArr[5] * bArr[13] + aArr[9] * bArr[14] + aArr[13] * bArr[15];
    matrixArr[14] = aArr[2] * bArr[12] + aArr[6] * bArr[13] + aArr[10] * bArr[14] + aArr[14] * bArr[15];
    matrixArr[15] = aArr[3] * bArr[12] + aArr[7] * bArr[13] + aArr[11] * bArr[14] + aArr[15] * bArr[15];
}
