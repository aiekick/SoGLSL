...
namespace ImGui
{
    ...
    void PlotFVec4Histo(const char* vLabel, ct::fvec4* vDatas, int vDataCount, bool* vShowChannel = 0, ImVec2 frame_size = ImVec2(0, 0),
                        ct::fvec4 scale_min = FLT_MAX, ct::fvec4 scale_max = FLT_MAX, int* vHoveredIdx = 0);
    }
