...
typedef std::function<void(RenderPackWeak, UniformVariantPtr, DisplayQualityType, MouseInterface*, CameraInterface*, MeshRectType*)>
    UpdateUniformFuncSignature;
...
enum class RenderPack_Type
{
	RENDERPACK_TYPE_BUFFER = 0,
	RENDERPACK_TYPE_COMPUTE,
	RENDERPACK_TYPE_Count
};
...
static const char* TexParamsComboString[3] = {
	"REPEAT\0CLAMP_TO_EDGE\0MIRRORED_REPEAT\0\0",
	"NEAREST\0NEAREST_MIPMAP_NEAREST\0LINEAR_MIPMAP_NEAREST\0NEAREST_MIPMAP_LINEAR\0LINEAR_MIPMAP_LINEAR\0\0",
	"NEAREST\0LINEAR\0\0" };
enum class UniformTextureWrapEnum
{
	wrapCLAMP_TO_EDGE = GL_CLAMP_TO_EDGE,
	wrapREPEAT = GL_REPEAT,
	wrapMIRRORED_REPEAT = GL_MIRRORED_REPEAT
};
...
enum class UniformTextureMagEnum
{
	magLINEAR = GL_LINEAR,
	magNEAREST = GL_NEAREST
};
enum class UniformTextureFormatEnum
{
	formatFLOAT = GL_FLOAT,
	formatBYTE = GL_UNSIGNED_BYTE
};
...
enum class ShaderPlaform
{
	SPF_UNKNOW = 0,
	SPf_SHADERTOY = 1,
	SPF_GLSLSANDBOX = 2,
	SPF_VERTEXSHADERART = 3
};
...
enum class ShaderBookTemplateEnum
{
	TEMPLATE_QUAD = 0,
	TEMPLATE_POINTS = 1,
	TEMPLATE_MUSIC = 2
...
static inline const char* GetShaderTypeEnumString(ShaderTypeEnum vShaderTypeEnum)
{
	...
	{
	case ShaderTypeEnum::SHADER_TYPE_VERTEX:
		return "VERTEX";
	case ShaderTypeEnum::SHADER_TYPE_GEOMETRY:
		return "GEOMETRY";
	case ShaderTypeEnum::SHADER_TYPE_TESSELATION_CONTROL:
		return "TESSCONTROL";
	case ShaderTypeEnum::SHADER_TYPE_TESSELATION_EVAL:
		return "TESSEVAL";
	case ShaderTypeEnum::SHADER_TYPE_FRAGMENT:
		return "FRAGMENT";
	case ShaderTypeEnum::SHADER_TYPE_COMPUTE:
		return "COMPUTE";
	case ShaderTypeEnum::NOTE_SPECIAL_TYPE:
		return "NOTE";
	case ShaderTypeEnum::LINK_SPECIAL_TYPE:
		return "LINK";
	case ShaderTypeEnum::SECTION_TYPE:
		return "SECTION";
	case ShaderTypeEnum::SECTION_COMMON:
		return "COMMON";
	}
	return "";
}
...
static inline std::string GetUniformRequestServiceEnumString(UniformRequestServiceEnum vUniformRequestServiceEnum)
{
	...
	{
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_MOUSE_2POSDELTA_SCREEN:
		return "MOUSE_2POSDELTA_SCREEN";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_MOUSE_2POSDELTA_SCREEN_RIGHT_BUTTON:
		return "MOUSE_2POSDELTA_SCREEN_RIGHT_BUTTON";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_MOUSE_2POS_2CLICKPOS_SCREEN:
		return "MOUSE_2POS_2CLICKPOS_SCREEN";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_MOUSE_2POS_NORMALIZED_CENTERED_SCREEN:
		return "MOUSE_2POS_NORMALIZED_CENTERED_SCREEN";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_MOUSE_2POS_RIGHT_BUTTON:
		return "MOUSE_2POS_RIGHT_BUTTON";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_MOUSE_2POS_SCREEN:
		return "MOUSE_2POS_SCREEN";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_NONE:
		return "NONE";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_SCREEN_SIZE_2:
		return "SCREEN_SIZE_2";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_SCREEN_SIZE_3:
		return "SCREEN_SIZE_3";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_BUFFER_SIZE_2:
		return "BUFFER_SIZE_2";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_FRAME_NUMBER:
		return "FRAME_NUMBER";
	case UniformRequestServiceEnum::UNIFORM_REQUEST_SERVICE_FRAME_RENDER_TIME:
...
enum class DocumentFragmentParseErrorEnum
{
	NOTHING = 0,
	BAD_XML_FORMAT = 1,
...
// Compilation Mode
enum class CompilationModeEnum
{
	COMPILATION_MODE_MANUAL = 0,
	COMPILATION_MODE_AUTO = 1
};
...
struct ProgramMsg
{
	...
	{
		return
			syntaxMsg == ShaderMsg::SHADER_MSG_ERROR ||
			vertexMsg == ShaderMsg::SHADER_MSG_ERROR ||
			fragmentMsg == ShaderMsg::SHADER_MSG_ERROR ||
			geometryMsg == ShaderMsg::SHADER_MSG_ERROR ||
			tesselationControlMsg == ShaderMsg::SHADER_MSG_ERROR ||
			tesselationEvalMsg == ShaderMsg::SHADER_MSG_ERROR ||
			computeMsg == ShaderMsg::SHADER_MSG_ERROR ||
			linkMsg == ShaderMsg::SHADER_MSG_ERROR;
	}

	bool isThereSomeWarnings()
	{
		return
			syntaxMsg == ShaderMsg::SHADER_MSG_WARNING ||
			vertexMsg == ShaderMsg::SHADER_MSG_WARNING ||
			fragmentMsg == ShaderMsg::SHADER_MSG_WARNING ||
			geometryMsg == ShaderMsg::SHADER_MSG_WARNING ||
			tesselationControlMsg == ShaderMsg::SHADER_MSG_WARNING ||
			tesselationEvalMsg == ShaderMsg::SHADER_MSG_WARNING ||
			computeMsg == ShaderMsg::SHADER_MSG_ERROR ||
			linkMsg == ShaderMsg::SHADER_MSG_WARNING;
	}
};
...
enum class UniformPlaceEnum
{
	UNIFORM_PLACE_NONE = 0,
	UNIFORM_PLACE_OUTPUT,
	UNIFORM_PLACE_INPUT,
	UNIFORM_PLACE_CONTROL
};

enum class BaseMeshFormatEnum
{
	PRIMITIVE_FORMAT_PNC = 0,
	PRIMITIVE_FORMAT_PNTC,
	PRIMITIVE_FORMAT_PNTBTC
};

enum class ModelModeEnum
{
	RENDERING_MODE = 0,
	EXPORT_MODE = 1
};
