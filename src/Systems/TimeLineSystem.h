...
private:
    ...
    int puTimeLineItemAxisMasks[4] = {TimeLineItemAxis::TIMELINE_AXIS_RED,
...
protected:
    ...
    TimeLineSystem& operator=(const TimeLineSystem&) {
        return *this;
    };                  // Prevent assignment
...
public:  // key manage
    ...
    void ReSizeControlPoints(ShaderKeyPtr vKey,
...
public:  // Interpolation
    ...
    float Interpolate_Quadratic(const int& vStartFrame,
                                ...
                                const float& vRatio,
                                bool vUseDerivation);
    float Interpolate_Bezier(const int& vStartFrame,
                             const float& vStartValue,
                             std::shared_ptr<UploadableUniform> vStart,
                             const int& vEndFrame,
                             const float& vEndValue,
                             ...
                             const float& vRatio,
                             bool vUseDerivation);
    float Interpolate(UniformTimeKey* vTimeKey,
...
private:  // ui
    ...
    bool
    ImGui_DrawTimeLineCurveGraph(ShaderKeyPtr vKey, float offsetY, float paneOffsetX, float paneOffsetY, ImRect frame_bb, int startFrame, int endFrame, bool hovered);
    ...
    bool ImGui_DrawGraphPointButton(UniformTimeKey* vKeyStruct, std::shared_ptr<UploadableUniform> vStruct, int vFrame, ImVec2 vPoint, bool vHovered);
    bool ImGui_DrawGraphSplinePointButton(UniformTimeKey* vKeyStruct,
                                          int vFrame,
                                          ImVec2 vBasePoint,
                                          ...
                                          int vAxis,
                                          ImRect vFrame_bb);
    bool ImGui_DrawGraphLineButton(UniformTimeKey* vKeyStruct,
                                   int vLastFrame,
                                   int vFrame,
                                   ImVec2 vStartPoint,
                                   ImVec2 vEndPoint,
