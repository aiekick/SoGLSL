...
bool Texture2D::InitFromBuffer(unsigned char const* /*buffer*/, int /*len*/, GLenum /*vTexType*/, bool /*vInvertY*/, bool /*vGenMipMap*/) {
    ...
    puBackTex = nullptr;  // PrepareFromBuffer(int vCountChannels, float *vBuffer, size_t vCount, ct::ivec2 vTextureSize, bool vGenMipMap, std::string vWrap, std::string
                          // vFilter);
...
ctTexturePtr Texture2D::PrepareFromBuffer(int /*vCountChannels*/,
                                          float* /*vBuffer*/,
                                          size_t /*vCount*/,
                                          ct::ivec2 /*vTextureSize*/,
                                          bool /*vGenMipMap*/,
                                          std::string /*vWrap*/,
                                          std::string /*vFilter*/) {
    return nullptr;
