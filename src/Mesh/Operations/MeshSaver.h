...
public:
    ...
    enum MeshFormatEnum { MESH_FORMAT_PLY = 0, MESH_FORMAT_OBJ, MESH_FORMAT_GLTF, MESH_FORMAT_FGA, MESH_FORMAT_VOX, MESh_FORMAT_Count };
...
protected:
    ...
    MeshSaver& operator=(const MeshSaver&) {
        return *this;
    };             // Prevent assignment
