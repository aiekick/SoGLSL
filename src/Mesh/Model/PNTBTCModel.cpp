...
PNTBTCModel::PNTBTCModel(const GuiBackend_Window& vWin) : BaseModel(vWin) {
...
PNTBTCMeshPtr PNTBTCModel::AddMesh(const PNTBTCMesh::VerticeArray& vVerticeArray, const PNTBTCMesh::IndiceArray& vIndiceArray) {
