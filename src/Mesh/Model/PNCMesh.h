...
public:
    ...
    static PNCMeshPtr Create(const GuiBackend_Window& vWin, const VerticeArray& vVerticeArray, const IndiceArray& vIndiceArray);

public:
    PNCMesh();
    PNCMesh(const GuiBackend_Window& vWin);
    PNCMesh(const GuiBackend_Window& vWin, const VerticeArray& vVerticeArray, const IndiceArray& vIndiceArray);
    ~PNCMesh();
