...
PNCMeshPtr PNCMesh::Create(const GuiBackend_Window& vWin, const VerticeArray& vVerticeArray, const IndiceArray& vIndiceArray) {
...
PNCMesh::PNCMesh(const GuiBackend_Window& vWin) : m_Window(vWin) {
}

PNCMesh::PNCMesh(const GuiBackend_Window& vWin, const VerticeArray& vVerticeArray, const IndiceArray& vIndiceArray) : m_Window(vWin) {
...
void PNCMesh::DrawModel(const std::string& vName,
                        const uint32_t& vIdx,
